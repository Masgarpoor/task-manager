...
!(function (e, t) {
            ...
            ce.forEach(r, function (r, i) {
              !0 ===
                (!(ce.isUndefined(r) || null === r) &&
                  o.call(t, r, ce.isString(i) ? i.trim() : i, n, h)) &&
                e(r, n ? n.concat(i) : [i]);
            }),
            l.pop();
        }
  ...
  function Oe(e, t, r) {
    ...
    if (
      (n = i
        ? i(t, r)
        : ce.isURLSearchParams(t)
        ? t.toString()
        : new ge(t, r).toString(o))
    ) {
      var a = e.indexOf("#");
      -1 !== a && (e = e.slice(0, a)),
        (e += (-1 === e.indexOf("?") ? "?" : "&") + n);
  ...
  var Se,
    ...
    Te = {
      ...
      classes: {
        URLSearchParams:
          "undefined" != typeof URLSearchParams ? URLSearchParams : ge,
  ...
  function Je(e, t, r) {
    fe.call(this, null == e ? "canceled" : e, fe.ERR_CANCELED, t, r),
      ...
      function (e) {
        return new Promise(function (t, r) {
          ...
          c.open(o.method.toUpperCase(), o.url, !0),
            ...
            (c.onabort = function () {
              c &&
                (r(new fe("Request aborted", fe.ECONNABORTED, o, c)),
                (c = null));
            }),
            (c.onerror = function () {
            ...
            ce.isUndefined(o.withCredentials) ||
          ...
          p && -1 === Le.protocols.indexOf(p)
            ? r(
                new fe("Unsupported protocol " + p + ":", fe.ERR_BAD_REQUEST, e)
              )
            : c.send(i || null);
        });
      },
      ...
      var r,
        ...
        o = function (e) {
          if (!r) {
            ...
            n.abort(
              t instanceof fe ? t : new Je(t instanceof Error ? t.message : t)
            );
          }
        },
        i =
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 11:
                      ...
                      (j = new Request(n, {
                        ...
                        ce.isFormData(i) &&
                          ...
                          d.setContentType(k),
                        j.body &&
                          (i = ct(j.body, 65536, ft(T, Ve(h)), null, pt));
                    case 15:
                      return (
                    ...
                    case 33:
                      ...
                      throw Object.assign(
                        new fe("Network Error", fe.ERR_NETWORK, t, x),
  ...
  var Et = function (e) {
    ...
    St = function (e) {
      for (
        var t, r, n = (e = ce.isArray(e) ? e : [e]).length, o = {}, i = 0;
        i < n;
        i++
      ) {
        var a = void 0;
        if (
          ((r = t = e[i]),
          !Ot(t) && void 0 === (r = wt[(a = String(t)).toLowerCase()]))
        )
  ...
  ce.forEach(["delete", "get", "head", "options"], function (e) {
    Lt.prototype[e] = function (t, r) {
      return this.request(
        Ze(r || {}, { method: e, url: t, data: (r || {}).data })
      );
    };
  }),
